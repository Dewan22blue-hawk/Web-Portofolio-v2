...
export default function MyCertificateContent() {
  ...
  return (
    <div id="mycertificate" className="flex flex-col items-center justify-center h-screen gap-3 align-middle">
      <div id="certificatetitle" className="flex flex-col items-center justify-center gap-6 md:w-6/12 max-sm:w-8/12">
        ...
        <span className="text-center text-white max-sm:text-xs" data-aos="zoom-in-up">
          ...
          {CertificateItems.map((item) => {
            return (
              ...
              >
                ...
                <span className="flex flex-col justify-center px-2 text-xs text-warning md:hidden">{item.name}</span>
              </div>
            );
          })}
        </ul>
